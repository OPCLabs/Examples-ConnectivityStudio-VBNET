...
#Region "Example"
' This example shows how to create a metric and implement reading its value using a function.
'
...
Namespace Global.SparkplugDocExamples.EdgeNode._SparkplugMetric
    Partial Class ReadValueFunction
        Public Shared Sub Main1()
            ...
            edgeNode.Add(New SparkplugMetric("ReadThisMetric").ReadValueFunction(Function() random.Next()))
