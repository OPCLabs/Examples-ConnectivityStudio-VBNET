...
#Region "Example"
' This example shows how to create a metric with pre-set constant value.
'
...
Namespace Global.SparkplugDocExamples.EdgeNode._SparkplugMetric
    Class ConstantValue
        Public Shared Sub Main1()
            ...
            ' Create a constant, read-only metric.
            ' The type of the metric (Int32, in this case) is inferred from the value.
            edgeNode.Add(New SparkplugMetric("ReadThisMetric").ConstantValue(42))
