...
#Region "Example"
' This example shows how to create a read-write metric of an array type that behaves like a register.
'
...
Namespace Global.SparkplugDocExamples.EdgeNode._SparkplugMetric
    Partial Class ReadWriteValue
        Public Shared Sub Array()
            ...
            edgeNode.Add(New SparkplugMetric("MyMetric").ReadWriteValue(New Integer() {42, 43, 44}))
