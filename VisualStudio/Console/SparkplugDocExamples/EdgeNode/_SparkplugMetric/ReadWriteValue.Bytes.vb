...
#Region "Example"
' This example shows how to create a read-write "register" metric of Sparkplug data type Bytes.
'
...
Namespace Global.SparkplugDocExamples.EdgeNode._SparkplugMetric
    Partial Class ReadWriteValue
        Public Shared Sub Bytes()
            ...
            ' The type of the metric (Bytes, in this case) is inferred from the initial value.
            ' An array of .NET Byte is used to represent the Bytes.
            edgeNode.Add(New SparkplugMetric("MyMetric").ReadWriteValue(New Byte() _
            {
